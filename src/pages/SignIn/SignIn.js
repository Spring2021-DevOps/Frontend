    ...
    <React.Fragment>
      <Paper className={classes.paper} elevation={6}>
        <div style={{}} className={classes.container}>
          ...
          <Button style={{ background: 'black' }} fullWidth variant="contained" margin="normal" color="secondary" onClick={handleSignOut} className={classes.buttonPadding}>
            {'Sign Out'}
          </Button>
          ...
          <Button style={{ background: 'black' }} fullWidth variant="contained" margin="normal" color="primary" onClick={handleFastSignIn} className={classes.buttonPadding}>
            {'Sign In'}
          </Button>
